...
|----------|-------------|--------------|-------------------|
| **Square** | Catalog Items API | `/v2/catalog/list` | Service items with variations (different durations/prices) |
| **Acuity** | Appointment Types API | `/api/v1/appointment-types` | Appointment types (single configuration per type) |
